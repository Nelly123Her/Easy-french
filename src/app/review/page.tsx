...
export default function Page() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 py-20 text-center">
      ...
      <h1 className="text-3xl font-bold text-[#1F2937] mb-3">Review</h1>
      <p className="text-gray-500 max-w-md mb-8">Revisit saved vocabulary, expressions, and exercises you found difficult. Coming next.</p>
